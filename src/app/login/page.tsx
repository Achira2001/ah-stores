...
import { LogIn, Loader2, ArrowLeft, CheckCircle2 } from "lucide-react";
  ...
  return (
    <div className="max-w-md mx-auto px-4 py-16">
      ...
      <div className="bg-white p-8 rounded-3xl border shadow-sm space-y-6">
        ...
        {registered && (
          <div className="p-4 rounded-xl text-sm font-semibold bg-green-50 text-green-700 border border-green-200 flex items-center gap-2">
        ...
        {error && (
          <div className="p-4 rounded-xl text-sm font-semibold bg-red-50 text-red-700 border border-red-200">
            {error}
          </div>
        )}
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-3 bg-white border border-gray-300 hover:bg-gray-50 text-gray-700 font-semibold py-2.5 rounded-xl transition shadow-sm"
        >
